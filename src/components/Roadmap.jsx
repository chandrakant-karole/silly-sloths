                            ...
                            <div className="roadMap_phase">
                                ...
                                <div className="roadMap_phase_content">
                                    ...
                                    <ul>
                                        ...
                                        <li>• Reward level 10 members with whitelist access </li>
                            ...
                            <div className="roadMap_phase">
                                ...
                                <div className="roadMap_phase_content">
                                    ...
                                    <ul>
                                        ...
                                        <li>•	Marketing – A fully baked marketing and communication plan will be put into action. The marketing will include press releases, partnerships, working with influencers and more. </li>
